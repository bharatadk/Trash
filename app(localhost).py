...
app.config['poppler_path']=r"D:\flask\Assignment\assignment 1\drive-download22\poppler-0.67.0_x86\poppler-0.67.0\bin"
db = SQLAlchemy(app)
bcrypt = Bcrypt(app)
    ...
    if request.method == "POST":
        ...
        for f in files:
            ...
            if extention in [".jpg", ".png", ".tiff", ".tif"]:
                ...
                pages = convert_from_path(os.path.join("./images", f.filename),poppler_path=app.config['poppler_path'])
